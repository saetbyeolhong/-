...
class JList1 extends JFrame implements ListSelectionListener {
	...
	private ImageIcon[] fruiticons = {
			new ImageIcon(getClass().getResource("persimmom.jpg")),
			new ImageIcon(getClass().getResource("banana.jpg")),
			new ImageIcon(getClass().getResource("apple.jpg")),
			new ImageIcon(getClass().getResource("grape.jpg")),
			new ImageIcon(getClass().getResource("cherry.jpg")),
			new ImageIcon(getClass().getResource("pear.jpg"))
	};
